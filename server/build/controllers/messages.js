...
var fetchDataFromFirebase = function fetchDataFromFirebase(callback) {
  var tokens = [''];

  _firebaseInit.db.collection("browser-tokens").onSnapshot(function (snap) {
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            data = _context2.sent;
            fetchDataFromFirebase(function (results) {
